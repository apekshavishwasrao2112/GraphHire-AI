...
GRAPH_PATH = """
MATCH p = shortestPath((start:Developer {email: $from_email})-[*]-(end:Developer {email: $to_email}))
RETURN p
"""
...
MATCH ()-[r]-()
WITH active_developers, companies, tech_domains, count(r) AS total_relationships
RETURN active_developers, companies, tech_domains, total_relationships
"""
...
RETURN d.full_name AS developer, collect(c.name) AS companies
"""
